...
function loadAIKeys() {
  return new Promise(function(resolve) {
    chrome.storage.local.get([
      'groqKey','nvidiaKey','geminiKey','openrouterKey',
      'cerebrasKey','mistralKey',
      'tavilyKey','elevenlabsKey','firecrawlKey',
      'pipedriveKey','hubspotKey','finnhubKey','invoiceGeneratorKey',
      'proxySecret',
      'aiProvider'
    ], function(r) {
      aiKeys = r || {};
...
chrome.storage.onChanged.addListener(function(changes) {
  if (changes.groqKey || changes.nvidiaKey || changes.geminiKey || changes.openrouterKey || changes.cerebrasKey || changes.mistralKey || changes.tavilyKey || changes.firecrawlKey || changes.pipedriveKey || changes.hubspotKey || changes.finnhubKey || changes.invoiceGeneratorKey || changes.proxySecret || changes.aiProvider) loadAIKeys();

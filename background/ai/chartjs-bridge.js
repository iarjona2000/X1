...
(function() {
  ...
  if (window.X1Integrations) {
    window.X1Integrations.register({ name: 'chartjs', version: '1.0.0', license: 'MIT', path: 'background/integrations/chartjs/', description: 'Graficos interactivos basados en canvas', healthCheck: function() { return window.X1ChartJSBridge.healthCheck(); }, dependencies: [] });
  }

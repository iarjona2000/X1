import { i as __toESM, n as __esmMin, t as __commonJSMin } from "./chunks/chunk-D9B2Ntkf.js";
import { B as init_store, L as init_gemini, M as getOllamaModels, N as init_ollama, P as isOllamaRunning, R as setGeminiKey, V as loadMessages, n as init_local, t as LocalProvider, v as init_conversation_summary, y as saveConversationSummary, z as appendMessage } from "./chunks/local-BHP_PqUJ.js";
import { a as loginGoogle, o as logoutGoogle, r as init_google } from "./chunks/google-Drr9iE04.js";
...
//#endregion
//#region src/sidepanel/components/ApprovalCard.tsx
function ApprovalCard({ approval, onDecision }) {
	const label = TOOL_LABELS$1[approval.toolName] || approval.toolName;
	return /* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("div", {
		className: "mx-4 my-2 border-2 border-[var(--black)] rounded-xl p-3 bg-white",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("div", {
				className: "text-[10px] font-semibold uppercase tracking-wider text-[var(--grey)] mb-1",
				style: { fontFamily: "var(--font-display)" },
				children: "Aprobacion requerida"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("div", {
				className: "text-[11px] text-[#666] mb-3 bg-[#F5F5F5] rounded-lg p-2 max-h-[120px] overflow-y-auto",
				children: /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("pre", {
					className: "whitespace-pre-wrap font-[var(--font-body)]",
					children: JSON.stringify(approval.args, null, 2)
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime$5.jsxs)("div", {
				className: "flex gap-2",
				children: [/* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("button", {
					onClick: () => onDecision(approval.actionId, true),
					className: "flex-1 py-1.5 rounded-lg bg-[var(--black)] text-white text-[12px] font-medium border-0 cursor-pointer hover:bg-[#333]",
					children: "Aprobar"
				}), /* @__PURE__ */ (0, import_jsx_runtime$5.jsx)("button", {
					onClick: () => onDecision(approval.actionId, false),
					className: "flex-1 py-1.5 rounded-lg bg-white text-[var(--black)] text-[12px] font-medium border border-[var(--border)] cursor-pointer hover:bg-[#F5F5F5]",
					children: "Rechazar"
				})]
			})
		]
...
var import_jsx_runtime$5, TOOL_LABELS$1;
var init_ApprovalCard = __esmMin((() => {
	require_react();
	...
	TOOL_LABELS$1 = {
		...
		sheets_append_rows: "Escribir en Sheets",
		tabs_close: "Cerrar pestana"
	};
}));
//#endregion
//#region src/sidepanel/components/Markdown.tsx
function parse(text) {
	const nodes = [];
	...
	while (i < lines.length) {
		...
		if (codeMatch) {
			...
			i++;
			nodes.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("pre", {
				className: "bg-[rgba(255,255,255,0.06)] rounded-lg p-3 my-2 overflow-x-auto text-[12px] leading-relaxed text-[rgba(255,255,255,0.75)]",
				children: /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("code", { children: codeLines.join("\n") })
			}, nodes.length));
			continue;
		}
		if (line.trim() === "") {
			nodes.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("div", { className: "h-2" }, nodes.length));
			i++;
			continue;
		}
		if (line.match(/^[-*]\s+/)) {
			...
			nodes.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("ul", {
				className: "my-1 ml-4 list-disc space-y-0.5",
				children: items.map((item, j) => /* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("li", {
					className: "text-[13px]",
					children: processInline(item)
				}, j))
			}, nodes.length));
			continue;
		}
		const processed = processInline(line);
		nodes.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("p", {
			className: "my-1",
			children: processed
		}, nodes.length));
		i++;
...
function processInline(text) {
	...
	while (remaining.length > 0) {
		...
		if (codeStart >= 0 && (boldStart === -1 || codeStart < boldStart) && (linkStart === -1 || codeStart < linkStart)) {
			if (codeStart > 0) parts.push(remaining.slice(0, codeStart));
			const rest = remaining.slice(codeStart + 1);
			const codeEnd = rest.indexOf("`");
			if (codeEnd >= 0) {
				parts.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("code", {
					className: "bg-[rgba(255,255,255,0.08)] px-1 rounded text-[12px] font-mono text-[#A78BFA]",
					children: rest.slice(0, codeEnd)
				}, idx++));
				remaining = rest.slice(codeEnd + 1);
			} else {
				parts.push("`");
				remaining = rest;
			}
		...
		if (boldStart >= 0 && (linkStart === -1 || boldStart < linkStart)) {
			if (boldStart > 0) parts.push(remaining.slice(0, boldStart));
			const rest = remaining.slice(boldStart + 2);
			const boldEnd = rest.indexOf("**");
			if (boldEnd >= 0) {
				parts.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("strong", { children: rest.slice(0, boldEnd) }, idx++));
				remaining = rest.slice(boldEnd + 2);
			} else {
				parts.push("**");
				remaining = rest;
			}
		...
		if (linkStart >= 0) {
			if (linkStart > 0) parts.push(remaining.slice(0, linkStart));
			const rest = remaining.slice(linkStart + 1);
			const textEnd = rest.indexOf("](");
			const urlEnd = rest.indexOf(")", textEnd + 2);
			if (textEnd >= 0 && urlEnd >= 0) {
				const linkText = rest.slice(0, textEnd);
				const url = rest.slice(textEnd + 2, urlEnd);
				parts.push(/* @__PURE__ */ (0, import_jsx_runtime$4.jsx)("a", {
					href: url,
					target: "_blank",
...
//#endregion
//#region src/sidepanel/components/JarvisView.tsx
function toolToApp(name) {
	if (name === "routing") return "x1";
	if (name.startsWith("gmail") || name === "email_triage") return "Gmail";
	if (name.startsWith("calendar") || name === "meeting_prep") return "Calendar";
	...
	if (name.startsWith("contacts_")) return "Contacts";
	if (name.startsWith("tabs") || name === "page_get_context" || name.startsWith("tab_")) return "Chrome";
	if (name === "navigate_to") return "Chrome";
	if (name.startsWith("scrape_") || name === "page_summarize") return "Chrome";
	if (name.startsWith("memory") || name.startsWith("graph") || name === "user_profile") return "Memoria";
	return "X1";
}
function speak(text, onEnd) {
	window.speechSynthesis.cancel();
	const clean = text.replace(/\*\*([^*]+)\*\*/g, "$1").replace(/[#_`>]/g, "").replace(/\[([^\]]+)\]\([^)]+\)/g, "$1");
...
function shouldShowText(userMsg) {
	const t = userMsg.toLowerCase();
	return /escr[ií]be|muestra|enseña|texto|pantalla|escrito|apunta|anota|lista/.test(t);
}
function JarvisView({ onOpenSettings }) {
	const [state, setState] = (0, import_react$3.useState)("idle");
	const [transcript, setTranscript] = (0, import_react$3.useState)("");
	const [response, setResponse] = (0, import_react$3.useState)("");
	const [showText, setShowText] = (0, import_react$3.useState)(false);
	const [pipeline, setPipeline] = (0, import_react$3.useState)([]);
	const [input, setInput] = (0, import_react$3.useState)("");
	const [pendingApprovals, setPendingApprovals] = (0, import_react$3.useState)([]);
	const [waveHeights, setWaveHeights] = (0, import_react$3.useState)([
		12,
		24,
		36,
		28,
	...
	const [orbPulse, setOrbPulse] = (0, import_react$3.useState)(0);
	const sendingRef = (0, import_react$3.useRef)(false);
	const abortRef = (0, import_react$3.useRef)(null);
	const pipelineRef = (0, import_react$3.useRef)([]);
	const toolsUsedRef = (0, import_react$3.useRef)([]);
	const pendingApprovalResolveRef = (0, import_react$3.useRef)(null);
	const responseRef = (0, import_react$3.useRef)("");
	const inputRef = (0, import_react$3.useRef)(null);
	const utteranceRef = (0, import_react$3.useRef)(null);
	(0, import_react$3.useEffect)(() => {
		if (state !== "listening") return;
		const id = setInterval(() => {
			setWaveHeights((prev) => prev.map(() => 8 + Math.random() * 32));
		}, 120);
	...
	(0, import_react$3.useEffect)(() => {
		...
		const id = setInterval(() => {
			setOrbPulse((p) => (p + 1) % 60);
		}, 50);
		return () => clearInterval(id);
	}, [state]);
	(0, import_react$3.useEffect)(() => {
		const check = (changes, area) => {
			if (area === "local" && changes.voice_pending_command?.newValue) {
				const cmd = changes.voice_pending_command.newValue;
				chrome.storage.local.remove("voice_pending_command");
				handleCommand(cmd);
			}
		};
		chrome.storage.onChanged.addListener(check);
		chrome.storage.local.get("voice_pending_command", (r) => {
			if (r.voice_pending_command) {
				chrome.storage.local.remove("voice_pending_command");
				handleCommand(r.voice_pending_command);
			}
		});
		return () => chrome.storage.onChanged.removeListener(check);
	}, []);
	(0, import_react$3.useEffect)(() => {
	...
	async function handleCommand(text) {
		...
		const userWantsText = shouldShowText(text);
		setShowText(userWantsText);
		setTranscript(text);
		setState("thinking");
		setResponse("");
		responseRef.current = "";
		...
		const history = (await loadMessages()).filter((m) => m.role === "user" || m.role === "assistant").filter((m) => m.status !== "error").slice(-20).map((m) => ({
			role: m.role,
			text: m.text
		}));
		...
		function handleApprovalRequest(toolName, args) {
			return new Promise((resolve) => {
				pendingApprovalResolveRef.current = resolve;
				const actionId = `approval_${Date.now()}`;
		...
		let fullText = "";
		try {
			for await (const event of provider.chat(text, abort.signal, handleApprovalRequest, history)) switch (event.type) {
				case "token":
					fullText += event.text || "";
					responseRef.current = fullText;
					if (userWantsText) setResponse(fullText);
					break;
				case "tool_call": {
					const tName = event.toolName || "";
					if (tName === "routing") break;
					if (tName) toolsUsedRef.current.push(tName);
					const app = toolToApp(tName);
					const path = pipelineRef.current;
					if (path.length > 0) path[path.length - 1].status = "done";
					path.push({
						app,
						tool: tName,
						label: TOOL_LABELS[tName] || tName,
						status: "running"
					});
					pipelineRef.current = path;
					setPipeline([...path]);
					break;
				}
				case "tool_result": {
					const path = pipelineRef.current;
					if (path.length > 0) {
						path[path.length - 1].status = "done";
						setPipeline([...path]);
					}
					break;
				}
				case "done": {
					...
					loadMessages().then((msgs) => {
						saveConversationSummary(msgs.slice(-20).map((m) => ({
							role: m.role,
							text: m.text
						})), toolsUsedRef.current).catch(() => {});
					}).catch(() => {});
					if (userWantsText) {
						...
						setState("speaking");
						setResponse(finalText);
						utteranceRef.current = speak(finalText, () => {
							setState("idle");
							setTranscript("");
							setPipeline([]);
						});
				...
				case "error":
					setResponse(event.message || "Error");
					setState("display");
					setShowText(true);
					break;
			}
	...
	function handleApproval(actionId, approved) {
		if (pendingApprovalResolveRef.current) {
			pendingApprovalResolveRef.current(approved);
	...
	const orbScale = 1 + .15 * Math.sin(orbPulse * Math.PI / 30);
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("span", {
					...
					children: [(state === "thinking" || state === "speaking") && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
						style: {
							display: "flex",
							alignItems: "center",
							gap: 5
						},
						children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", { style: {
							width: 5,
							height: 5,
							borderRadius: "50%",
							background: state === "speaking" ? "#34D399" : "#7C6AFF"
						} }), /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("span", {
							style: {
								fontSize: 10,
								color: state === "speaking" ? "rgba(52,211,153,0.6)" : "rgba(124,106,255,0.6)"
							},
							children: state === "speaking" ? "Hablando" : "Trabajando"
						})]
			...
			/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
				...
				children: [
					state === "idle" && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)(import_jsx_runtime$3.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
						style: {
							position: "relative",
							width: 80,
							height: 80
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", { style: {
								width: 80,
								height: 80,
								borderRadius: "50%",
						...
						children: "Di algo o escribe abajo"
					})] }),
					state === "listening" && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)(import_jsx_runtime$3.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
							style: {
								display: "flex",
								alignItems: "center",
							...
							children: waveHeights.map((h, i) => /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", { style: {
								width: 3,
								height: h,
								borderRadius: 2,
								background: "#7C6AFF",
					...
					state === "thinking" && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)(import_jsx_runtime$3.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
							style: {
								position: "relative",
								width: 60,
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", { style: {
								...
								height: 60,
								borderRadius: "50%",
								background: "radial-gradient(circle at 40% 40%, rgba(124,106,255,0.35), rgba(124,106,255,0.08))",
								border: "1px solid rgba(124,106,255,0.2)",
								transform: `scale(${orbScale})`,
								transition: "transform 0.05s ease"
							} })
						}),
						transcript && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
							style: {
								fontSize: 12,
								color: "rgba(255,255,255,0.3)",
								maxWidth: 260
						...
						pipeline.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
							style: {
								width: "100%",
								maxWidth: 280,
								textAlign: "left"
							},
							children: pipeline.map((step, i) => /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)(import_react$3.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
								style: {
									display: "flex",
									alignItems: "center",
									gap: 10,
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
									style: {
										...
										fontSize: 11,
										flexShrink: 0,
										background: step.status === "done" ? "rgba(52,211,153,0.15)" : "rgba(124,106,255,0.15)",
										color: step.status === "done" ? "#34D399" : "#7C6AFF"
									},
									children: step.status === "done" ? "✓" : "●"
								}), /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
									style: {
										fontSize: 11,
							...
							}), i < pipeline.length - 1 && /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", { style: {
								width: 1,
								height: 8,
					...
					state === "speaking" && !showText && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)(import_jsx_runtime$3.Fragment, { children: [
						/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
							style: {
								position: "relative",
								width: 80,
					...
					state === "display" && /* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
						style: {
							flex: 1,
							width: "100%",
							overflowY: "auto",
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)(Markdown, { text: response })
						}), /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("button", {
					...
					state === "speaking" && showText && /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
						style: {
							flex: 1,
							width: "100%",
							overflowY: "auto",
			...
			pendingApprovals.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("div", {
				style: { padding: "0 16px 8px" },
				children: pendingApprovals.map((a) => /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)(ApprovalCard, {
					approval: a,
			...
			/* @__PURE__ */ (0, import_jsx_runtime$3.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("input", {
					...
					placeholder: state === "thinking" ? "Procesando..." : "Escribe aquí...",
					style: {
						flex: 1,
				...
				}), state === "thinking" || state === "speaking" ? /* @__PURE__ */ (0, import_jsx_runtime$3.jsx)("button", {
					onClick: stopAll,
					style: {
						width: 36,
						height: 36,
					...
					style: {
						...
						height: 36,
						borderRadius: 10,
						background: input.trim() ? "rgba(124,106,255,0.15)" : "rgba(255,255,255,0.04)",
						border: `1px solid ${input.trim() ? "rgba(124,106,255,0.3)" : "rgba(255,255,255,0.08)"}`,
						color: input.trim() ? "#7C6AFF" : "rgba(255,255,255,0.15)",
						fontSize: 16,
...
var import_react$3, import_jsx_runtime$3, TOOL_LABELS;
var init_JarvisView = __esmMin((() => {
	import_react$3 = /* @__PURE__ */ __toESM(require_react());
	init_ApprovalCard();
	init_Markdown();
	init_store();
	init_local();
	init_conversation_summary();
	import_jsx_runtime$3 = require_jsx_runtime();
	TOOL_LABELS = {
		gmail_search: "Buscar emails",
		gmail_get_message: "Leer email",
		gmail_create_draft: "Crear borrador",
		gmail_send: "Enviar email",
		gmail_reply: "Responder email",
		email_triage: "Triaje de emails",
		calendar_list_events: "Ver calendario",
		calendar_create_event: "Crear evento",
		calendar_get_free_busy: "Disponibilidad",
		calendar_update_event: "Editar evento",
		sheets_read: "Leer hoja",
		sheets_append_rows: "Añadir filas",
		sheets_create: "Crear hoja",
		docs_create: "Crear documento",
		docs_get: "Leer documento",
		drive_list: "Listar Drive",
		drive_search: "Buscar en Drive",
		tasks_list: "Ver tareas",
		tasks_create: "Crear tarea",
		contacts_list: "Ver contactos",
		contacts_search: "Buscar contacto",
		tabs_list: "Ver pestañas",
		tabs_open: "Abrir pestaña",
		navigate_to: "Navegar a",
		page_get_context: "Leer página",
		scrape_page: "Extraer contenido",
		page_summarize: "Resumir página",
		memory_save: "Guardar en memoria",
		memory_search: "Buscar en memoria",
		morning_brief: "Resumen del día",
		meeting_prep: "Preparar reunión"
	};
}));
//#endregion
//#region src/sidepanel/components/SettingsView.tsx
function SettingsView() {
	const [provider, setProvider] = (0, import_react$2.useState)("ollama");
	const [ollamaStatus, setOllamaStatus] = (0, import_react$2.useState)("checking");
	const [ollamaModels, setOllamaModels] = (0, import_react$2.useState)([]);
	const [selectedModel, setSelectedModel] = (0, import_react$2.useState)("llama3.2");
	const [googleConnected, setGoogleConnected] = (0, import_react$2.useState)(false);
	const [geminiConfigured, setGeminiConfigured] = (0, import_react$2.useState)(false);
	const [geminiKey, setGeminiKeyVal] = (0, import_react$2.useState)("");
	const [keyVisible, setKeyVisible] = (0, import_react$2.useState)(false);
	const [saving, setSaving] = (0, import_react$2.useState)(false);
	const [message, setMessage] = (0, import_react$2.useState)("");
	const [privacy, setPrivacy] = (0, import_react$2.useState)(DEFAULT_PRIVACY);
	const [extId, setExtId] = (0, import_react$2.useState)("");
	const [voiceEnabled, setVoiceEnabled] = (0, import_react$2.useState)(false);
	(0, import_react$2.useEffect)(() => {
		...
		chrome.storage.local.get("voice_enabled", (r) => setVoiceEnabled(!!r.voice_enabled));
	}, []);
	async function init() {
		const { llm_provider, ollama_model, privacy: storedPrivacy, google_connected } = await chrome.storage.local.get([
			"llm_provider",
			"ollama_model",
			"privacy",
			"google_connected"
		]);
		if (llm_provider) setProvider(llm_provider);
		if (ollama_model) setSelectedModel(ollama_model);
		if (storedPrivacy) setPrivacy(storedPrivacy);
		if (google_connected) setGoogleConnected(true);
		try {
			const resp = await chrome.runtime.sendMessage({ type: "GET_SETTINGS" });
			if (resp) {
				if (resp.geminiConfigured !== void 0) setGeminiConfigured(resp.geminiConfigured);
			}
		} catch {}
	}
	async function checkOllama() {
		...
		if (running) setOllamaModels(await getOllamaModels());
	}
	async function handleProviderChange(p) {
		setProvider(p);
		await chrome.storage.local.set({ llm_provider: p });
		setMessage(p === "ollama" ? "Usando Ollama (local, gratis)" : "Usando Gemini (requiere API key)");
	}
	async function handleModelChange(model) {
		setSelectedModel(model);
		await chrome.storage.local.set({ ollama_model: model });
	}
	async function handleGoogleLogin() {
		...
		try {
			...
			setMessage(`Error: ${e?.message || e?.toString() || "desconocido"}`);
		}
		setSaving(false);
	}
	async function handleGoogleLogout() {
		await logoutGoogle();
		await chrome.storage.local.set({ google_connected: false });
		setMessage("Google desconectado");
		setGoogleConnected(false);
	}
	async function handleCheckGoogle() {
		try {
			const resp = await chrome.runtime.sendMessage({ type: "GET_SETTINGS" });
			setGoogleConnected(resp?.googleConnected || false);
			setMessage(resp?.googleConnected ? "Conexión verificada" : "No conectado");
		} catch {
			setMessage("No se pudo verificar el estado");
		}
	}
	...
	async function handlePrivacyToggle(key) {
		...
		setPrivacy(updated);
		await chrome.storage.local.set({ privacy: updated });
		try {
			await chrome.runtime.sendMessage({
				type: "UPDATE_PRIVACY",
				settings: updated
	...
	async function handleClearData(target) {
		...
		setMessage(`${labels[target]} borrados`);
	}
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
		className: "flex-1 overflow-y-auto px-4 py-3",
		children: [
			message && /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
				className: "mb-3 px-3 py-2 bg-[rgba(255,255,255,0.06)] rounded-lg text-[12px] text-[rgba(255,255,255,0.7)]",
				children: message
			}),
			/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Section, {
				title: "Google",
				children: /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
						className: "text-[12px]",
						children: googleConnected ? "Conectado" : "No conectado"
					}), /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
						className: "text-[10px] text-[#999]",
						children: "Gmail, Calendar, Sheets, Drive"
					})] }), /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
						className: "flex gap-1.5",
						children: [googleConnected ? /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							...
							children: saving ? "..." : "Conectar"
						}), /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							onClick: handleCheckGoogle,
							className: "btn-secondary text-[9px] px-1.5",
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							...
							className: `flex-1 py-1.5 rounded-lg text-[11px] font-medium border transition-colors ${provider === "ollama" ? "bg-[var(--black)] text-white border-[var(--black)]" : "bg-white text-[var(--black)] border-[var(--border)] hover:border-[var(--black)]"}`,
							children: "Ollama (local)"
						}), /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							onClick: () => handleProviderChange("gemini"),
							className: `flex-1 py-1.5 rounded-lg text-[11px] font-medium border transition-colors ${provider === "gemini" ? "bg-[var(--black)] text-white border-[var(--black)]" : "bg-white text-[var(--black)] border-[var(--border)] hover:border-[var(--black)]"}`,
							children: "Gemini (API)"
						})]
					}),
					provider === "ollama" && /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", { children: [
						/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
							className: "flex items-center gap-2 mb-2",
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", { className: `w-2 h-2 rounded-full ${ollamaStatus === "running" ? "bg-green-500" : ollamaStatus === "stopped" ? "bg-red-400" : "bg-yellow-400"}` }),
								/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", {
									className: "text-[11px]",
									children: ollamaStatus === "running" ? "Ollama activo" : ollamaStatus === "stopped" ? "Ollama no detectado" : "Comprobando..."
								}),
								/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
									onClick: checkOllama,
									className: "text-[10px] text-[#999] underline ml-auto",
									children: "Reintentar"
								})
							]
						}),
						ollamaStatus === "stopped" && /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
							className: "text-[10px] text-[#999] mb-2",
							children: "Abre Ollama en tu PC para usarlo. Es gratis y local."
						}),
						ollamaModels.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("select", {
							value: selectedModel,
							onChange: (e) => handleModelChange(e.target.value),
							className: "w-full border border-[rgba(255,255,255,0.1)] rounded-lg px-2.5 py-1.5 text-[12px] outline-none focus:border-[#7C6AFF] bg-[rgba(255,255,255,0.04)] text-white",
							children: ollamaModels.map((m) => /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("option", {
								value: m,
								children: m
							}, m))
						})
					] }),
					provider === "gemini" && /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
						className: "text-[10px] text-[#999] mb-2",
						children: geminiConfigured ? "API key configurada" : "Necesitas una API key de Google AI Studio"
					}), /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
						className: "flex gap-2",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("input", {
								...
								placeholder: "AIza...",
								className: "flex-1 border border-[rgba(255,255,255,0.1)] rounded-lg px-2.5 py-1.5 text-[12px] outline-none focus:border-[#7C6AFF] bg-[rgba(255,255,255,0.04)] text-white",
								style: { fontFamily: "var(--font-body)" }
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
								onClick: () => setKeyVisible(!keyVisible),
								className: "btn-secondary text-[10px] px-2",
								children: keyVisible ? "Ocultar" : "Ver"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)(Section, {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
						className: "text-[12px]",
						children: "Activar por voz"
					}), /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
						className: "text-[10px] text-[#999]",
						children: "Di \"Hey Boss\" o \"Hola X1\" para activar"
					})] }), /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
						type: "button",
						onClick: () => {
							const next = !voiceEnabled;
							setVoiceEnabled(next);
							chrome.storage.local.set({ voice_enabled: next });
							setMessage(next ? "Voz activada — di \"Hey Boss\" para empezar" : "Voz desactivada");
							if (next && navigator.mediaDevices?.getUserMedia) navigator.mediaDevices.getUserMedia({ audio: true }).then((s) => s.getTracks().forEach((t) => t.stop())).catch(() => {});
						},
						className: `relative w-9 h-5 rounded-full border-0 cursor-pointer transition-colors shrink-0 ${voiceEnabled ? "bg-[var(--black)]" : "bg-[#DDD]"}`,
						style: {
							minWidth: "36px",
							minHeight: "20px"
						},
						children: /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", { className: `absolute top-0.5 w-4 h-4 bg-white rounded-full transition-transform shadow-sm ${voiceEnabled ? "left-[18px]" : "left-0.5"}` })
					})]
				}), voiceEnabled && /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
					className: "flex items-center gap-2 text-[11px] text-green-600",
					children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", { className: "w-2 h-2 rounded-full bg-green-500 animate-pulse" }), "Escuchando wake word..."]
				})]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)(Section, {
				title: "Privacidad",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Toggle, {
						label: "Escanear emails",
						checked: privacy.scanEmails,
						onChange: () => handlePrivacyToggle("scanEmails")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Toggle, {
						label: "Escanear calendario",
						checked: privacy.scanCalendar,
						onChange: () => handlePrivacyToggle("scanCalendar")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Toggle, {
						label: "Escanear pestanas",
						checked: privacy.scanTabs,
						onChange: () => handlePrivacyToggle("scanTabs")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Toggle, {
						label: "Guardar en memoria",
						checked: privacy.saveMemory,
						onChange: () => handlePrivacyToggle("saveMemory")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Toggle, {
						label: "Alertas proactivas",
						checked: privacy.proactiveAlerts,
						onChange: () => handlePrivacyToggle("proactiveAlerts")
					})
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)(Section, {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							...
							children: "Borrar memoria"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
							onClick: () => handleClearData("graph"),
							className: "btn-danger",
							children: "Borrar grafo de contexto"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("button", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
				className: "text-[9px] text-[rgba(255,255,255,0.15)] text-center mt-6 mb-4",
				children: "X1 v2.0.0 — Todos los datos se quedan en tu navegador."
			}),
			extId && /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
				className: "text-[8px] text-[rgba(255,255,255,0.1)] text-center mb-2",
				children: ["ID: ", extId]
			})
		]
	});
...
function Section({ title, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("div", {
			className: "text-[10px] font-semibold uppercase tracking-wider text-[var(--grey)] mb-2",
			style: { fontFamily: "var(--font-display)" },
			children: title
		}), children]
	});
...
function Toggle({ label, checked, onChange }) {
	return /* @__PURE__ */ (0, import_jsx_runtime$2.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", {
			...
			onClick: onChange,
			className: `relative w-9 h-5 rounded-full border-0 cursor-pointer transition-colors ${checked ? "bg-[var(--black)]" : "bg-[#DDD]"}`,
			children: /* @__PURE__ */ (0, import_jsx_runtime$2.jsx)("span", { className: `absolute top-0.5 w-4 h-4 bg-white rounded-full transition-transform shadow-sm ${checked ? "left-[18px]" : "left-0.5"}` })
		})]
	});
}
var import_react$2, import_jsx_runtime$2, DEFAULT_PRIVACY;
var init_SettingsView = __esmMin((() => {
...
//#endregion
//#region src/sidepanel/App.tsx
function App() {
	const [showSettings, setShowSettings] = (0, import_react$1.useState)(false);
	return /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)(import_jsx_runtime$1.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(JarvisView, { onOpenSettings: () => setShowSettings(true) }), showSettings && /* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
		style: {
			position: "fixed",
			inset: 0,
			zIndex: 100,
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime$1.jsxs)("div", {
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime$1.jsx)(SettingsView, {})
		})]
	})] });
}
...
//#endregion
//#region src/sidepanel/index.css
var init_sidepanel = __esmMin((() => {}));

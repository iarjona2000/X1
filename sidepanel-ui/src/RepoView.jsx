                ...
                {items.map(item => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.preview && (
                        <div style={{ fontSize: '12px', color: '#59636e', marginTop: '10px', marginLeft: '26px',
                          lineHeight: '1.7', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{item.preview}</div>
                      )}
                    </div>
                  );
                })}

...
|---|---|---|---|
| Research Agent | [[Agentes-Research/OpenOSINT\|OpenOSINT]] | 1 (MCP) | Alta — MCP ya soportado, coste ~0 |
| CMO / SEO | [[Agentes-Marketing/OpenSEO\|OpenSEO]] | 1 (MCP) | Alta |
| CLO (Legal) | [[Agentes-Legal/OpenContracts\|OpenContracts]] | 1 (MCP) | Alta |
| CFO | [[Agentes-Finanzas/AI-CFO-Agent\|AI CFO Agent]] | 2 (self-hosted) | Media — **código ya escrito** en X1 (`cfoAgentAnalyze()`), sin probar en vivo |
| CHRO (RRHH) | [[Agentes-RRHH/Hiring-Agent-Interviewstreet\|Hiring Agent]] | 2/3 | Media |
| COO / Operaciones | [[Agentes-Operaciones/Plexo\|Plexo]] | 2 | Media (cambiado de PMO-CrewAI 2026-07-04: ese repo está en "DRAFT stage", sin instalación documentada) |
| Customer Service | [[Agentes-Atencion-Cliente/Chatwoot\|Chatwoot]] | 2 (API propia) | Media — despliegue no es de una línea, ver nota del agente |

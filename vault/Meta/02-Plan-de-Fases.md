...
**Nota 2026-07-06:** carpetas renombradas a `CEO-Departamento` (ej. `Agentes-CFO-Finanzas`) para que se vea el CEO y el tema a la vez. Los documentos meta (este incluido) se movieron a `Meta/`. Nuevos clústeres transversales sin CEO: `Sistema-Orquestacion/` (documenta, sin tocar código, el Juez/Voting/Router/Pool/Ensemble del socio) y `Codigo-Seguridad/` (arquitectura y seguridad de la extensión X1).
...
|---|---|---|---|
| Research Agent (bajo CEO) | [[Agentes-CEO-Estrategia/OpenOSINT\|OpenOSINT]] | 1 (MCP) | Alta — MCP ya soportado, coste ~0 |
| CMO / SEO | [[Agentes-CMO-Marketing/OpenSEO\|OpenSEO]] | 1 (MCP) | Alta |
| CLO (Legal) | [[Agentes-CLO-Legal/OpenContracts\|OpenContracts]] | 1 (MCP) | Alta |
| CFO | [[Agentes-CFO-Finanzas/AI-CFO-Agent\|AI CFO Agent]] | 2 (self-hosted) | Media — **código ya escrito** en X1 (`cfoAgentAnalyze()`), sin probar en vivo |
| CHRO (RRHH) | [[Agentes-CHRO-RRHH/Hiring-Agent-Interviewstreet\|Hiring Agent]] | 2/3 | Media |
| COO / Operaciones | [[Agentes-COO-Operaciones/Plexo\|Plexo]] | 2 | Media (cambiado de PMO-CrewAI 2026-07-04: ese repo está en "DRAFT stage", sin instalación documentada) |
| Customer Service (bajo COO) | [[Agentes-COO-Operaciones/Chatwoot\|Chatwoot]] | 2 (API propia) | Media — despliegue no es de una línea, ver nota del agente |
